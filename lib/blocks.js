...
export default function (vm) {
    ...
    const ippColors = ScratchBlocks.Colours.ipp;
    ...
    ScratchBlocks.Blocks.car_to_menu.init = function () {
        const front = ScratchBlocks.ScratchMsgs.translate('IPP_CAR_TO_SELECT_FRONT', 'front');
        const back = ScratchBlocks.ScratchMsgs.translate('IPP_CAR_TO_SELECT_BACK', 'back');
        const json = jsonForMenuBlock('TO', spriteMenu, ippColors, [
            [front, '1'],
            [back, '-1']
        ]);
        this.jsonInit(json);
